...
--env FABRIC_CA_CLIENT_MSPDIR=tls-msp \
...
/bin/bash -c \
"fabric-ca-client enroll -d -u https://peer1-org1:peer1PW@ca-tls:7054; chmod -R 777 /tmp/hyperledger/fabric-ca/peer1/tls-msp"
