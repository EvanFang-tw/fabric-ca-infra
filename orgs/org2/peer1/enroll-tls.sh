...
/bin/bash -c \
"fabric-ca-client enroll -d -u https://peer1-org2:peer1PW@ca-tls:7054; chmod -R 777 /tmp/hyperledger/fabric-ca/peer1/tls"

# Rename key
KEY_DIR=crypto/peer1/tls/keystore
mv -f $KEY_DIR/*_sk $KEY_DIR/tls.key

# Rename cert
CERT_DIR=crypto/peer1/tls/signcerts
mv -f $CERT_DIR/*.pem $CERT_DIR/tls.crt

# Rename tls ca cert
CACERT_DIR=crypto/peer1/tls/cacerts
